...
<html lang="pt-br">
    <head>
        ...
        <title>BarberShop / BelezaConectada</title>
    </head>
...
<body>
    ...
    <main class="caixa1" id="main">
      <nav class="navbar navbar-expand-lg navbar-dark" id="menurespbg">
        <div class="container">
          <a href="" class="navbar-brand ml-5"><img class="mr-3 logo" src="img/logo.jpg" style="width: 80px;"><h3 class="d-inline nomempresa">Barber Shop /BelezaConectada
          </h3></a>
        ...
        <div class="row align-items-center">
          <div class="col marcar">
            <div class="mt-5">
              ...
              <div>
                <a href="#"><img src="img/aa.png" class="redes-sociais whats mr-4"></a>
                <!-- <a href="#"><img src="img/a.png" class="redes-sociais insta"></a> -->
              </div>
    ...
    <div class="caixa5">
      <div class="conteudo-titulo">
        <span class="titulo">BelezaConectada - Inovação em Cada Corte!</span>
      </div>
    </div>
